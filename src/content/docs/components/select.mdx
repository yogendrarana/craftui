...
---
#### Single Select
<ComponentCodePreview name="select-demo" category="examples" />

#### Multiple Select 
<ComponentCodePreview name="select-multiple" category="examples" />

#### Select with groups and disabled options
<ComponentCodePreview name="select-groups" category="examples" />

#### Searchable Select
<ComponentCodePreview name="select-searchable" category="examples" />

#### Select which shows create new option if search value does not match any option
<ComponentCodePreview name="select-creatable" category="examples" />

#### Custom load async options function
<ComponentCodePreview name="select-loading-async-options" category="examples" hasReTrigger />

#### Controlled select
<ComponentCodePreview name="select-controlled" category="examples" />
...
<ComponentSource name="select" category="core" />
