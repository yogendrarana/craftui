...
---
#### Single Select
<ComponentCodePreview name="demo-ui-select" category="demo" />

#### Multiple Select 
<ComponentCodePreview name="demo-ui-select-multiple" category="demo" />

#### Select with groups and disabled options
<ComponentCodePreview name="demo-ui-select-groups" category="demo" />

#### Searchable Select
<ComponentCodePreview name="demo-ui-select-searchable" category="demo" />

#### Select which shows create new option if search value does not match any option
<ComponentCodePreview name="demo-ui-select-creatable" category="demo" />

#### Loading async options
<ComponentCodePreview name="demo-ui-select-loading-async" category="demo" hasReTrigger />

#### Controlled select
<ComponentCodePreview name="demo-ui-select-controlled" category="demo" />
