...
<Installation name="ui-select" />

## Demo

#### Single Select

<ComponentCodePreview name="demo-ui-select" />

#### Multiple Select

<ComponentCodePreview name="demo-ui-select-multiple" />

#### Select with groups and disabled options

<ComponentCodePreview name="demo-ui-select-groups" />

#### Searchable Select

<ComponentCodePreview name="demo-ui-select-searchable" />

#### Select which shows create new option if search value does not match any option

<ComponentCodePreview name="demo-ui-select-creatable" />

#### Loading async options

<ComponentCodePreview name="demo-ui-select-loading-async" hasReTrigger />

#### Controlled select

<ComponentCodePreview name="demo-ui-select-controlled" />
