...
#### Basic Text Scramble
<ComponentCodePreview name="demo-text-text-scramble" category="demo" hasReTrigger />

#### Text Scramble on Hover
<ComponentCodePreview name="demo-text-text-scramble-custom-trigger" category="demo" />

#### Text Scramble with Custom Chars
<ComponentCodePreview name="demo-text-text-scramble-custom-chars" category="demo" hasReTrigger />
...
<ComponentSource name="text-text-scramble" />
